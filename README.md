A render engine used to create 3-dimensional graphical scene using ray tracing, supersampling, depth of field, boundry box volume hierarchy, threadpoll multi-threading. 
